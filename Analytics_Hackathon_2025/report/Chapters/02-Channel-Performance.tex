...

{
	...
	AdventureWorks distributes its products through two channels: the \textbf{Online} channel (Direct-to-Consumer) and the \textbf{Reseller} channel (Business-to-Business). These channels handle money and profit very differently. The Reseller channel is responsible for the highest sales volume, but the Online channel is the most stable source of profit.
