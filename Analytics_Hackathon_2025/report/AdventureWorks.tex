...
\documentclass[
    ...
    coverstyle=classic
]{AdventureWorksThesis} % Refer to the Wiki for a list of available options.
...
\include{Chapters/02-Channel-Performance}
\include{Chapters/03-Customer-Segmentation}
\include{Chapters/04-Product-Optimisation}
